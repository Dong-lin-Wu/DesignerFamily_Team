                    ...
                    <div class="pd-ltr-20 xs-pd-20-10">
                        <div class="min-height-200px">
                            <div class="page-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 text-right">
                                        <a class="btn btn-primary" href="/forum/forum_backend_gotoinsert.controller" role="button">新增</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-box mb-30">
                                <div class="pd-20">
                                    <h4 class="text-blue h4">討論區清單</h4>
                                </div>
                                <div class="pb-20">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="/forum/discussDetails?=${dl.getForumid()}"><i
                                                                        class="dw dw-eye"></i>
                                                                    詳細</a>  
                                                                    <a class="dropdown-item"
