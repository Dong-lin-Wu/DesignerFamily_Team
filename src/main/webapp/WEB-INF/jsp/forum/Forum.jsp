	      		...
	      		<tr>
					...
					<!-- Button trigger modal -->
						...
						<form style="display:inline" action="forum_backend_gotocommentindex.controller" method="post">							
							...
							<button type="submit" class="btn btn-success">評論${dl.commentBean.size()}</button> <!-- size()為set的方法 -->
						</form>
					    ...
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					       ...
					       <!--
					        ...
					        -->						         					        
					        <textarea class="form-control" id="exampleFormControlTextarea1" style="height: 700px">${dl.getForumDescription()}</textarea>					        					       		        
					      </div>
					      <div class="modal-footer">
