<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="tw.designerfamily.raise.model.RaiseBean, tw.designerfamily.raise.model.RaisePlanBean, java.util.List, java.util.Set"%>
...
<body>
	<div class='container'>
		...
		<c:choose>
		    <c:when test="${donext=='RaiseReview'}">
		    </form>
