			...
			<button type="submit" class="btn btn-outline-dark" style="margin-bottom:10px" >回上一頁</button>
				...
				<form action="newsAdd" method="post" >
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control nBlank" id="newsTitle" name="newsTitle"/>					
					</div>
					<div class="mb-3">
						<label for="newsSubtitle" class="form-label"><b>副標題</b></label> 
						<input type="text" class="form-control" id="newsSubtitle" name="newsSubtitle"/>
					</div>
					<div class="mb-3">
						<label for="newsContent" class="form-label"><b>活動內容</b>&emsp;<span style="color:red"></span></label><em id="contentError" class="red"></em>
						<textarea class="form-control nBlank" id="newsContent" rows="12" style="resize: none" name="newsContent"></textarea>						
					</div>

			        <div class="mb-3">
	            		<label class="form-label" ><b>活動照片</b></label>
	            		<input class="form-control uploadImages" style="width:280px" type="file" name="PicBase64"/>
					...
					<div class="mb-3">
						...
						<textarea class="form-control" id="newsNote" rows="4" style="resize: none" name="newsNote"></textarea>						
					</div>	
	        							
					<button type="submit" class="btn btn-primary send" name="upload">送出</button>
					<div style="text-align: center; width: auto; margin: 20px auto;float: right" >
