		...
		<div class="pd-ltr-20">
				...
				<div id="searchtb_productinfo" style="padding: 2px 5px;">
					<div class="col-auto" style="padding: 0px">
						<a href="news/newsadd" style="float:left">
						<button type="button" class="btn btn-outline-primary" style="margin-bottom:15px">新增</button></a>
					</div>
				</div>
				...
				<tbody>
					<c:forEach var="n1" items="${list}">
						<tr>
							...
							<a href="/news/newsupdate/${n1.newsId}"><button style="display: inline" class="btn btn-outline-success btn-sm ">修改</button></a>
							<a href="/news/detail/${n1.newsId}"><button style="display: inline" class="btn btn-outline-primary btn-sm det">詳細</button></a>
							</td>
					</c:forEach>
				</tbody>
			</table>
 ...
 $(document).ready(function() {
    ...
    swalWithBootstrapButtons.fire(
	 ...
	 $('.det').on("click",function(e){
		 ...
		 console.log(id);
		 Swal.fire({
		      html:'<iframe src = /news/detail/'+id+' width="600px" height="500px">',
		      width:"800px"
			})
	 })
