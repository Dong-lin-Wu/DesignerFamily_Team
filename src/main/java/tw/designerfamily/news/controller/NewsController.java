...
public class NewsController {
	...
	@RequestParam(value="newsSubtitle",required=false) String subtitle,@RequestParam("newsContent")String content,
	@RequestParam(value="news_PicBase64",required=false)String picbase64,@RequestParam(value="newsNote",required=false)String note) {
	...
	public String updateNews(@RequestParam("newsId") int id,@RequestParam("newsType")String type,@RequestParam("newsTitle") String title,
			@RequestParam(value="newsSubtitle",required=false) String subtitle,@RequestParam("newsContent")String content,
			@RequestParam(value="news_PicBase64",required=false)String picbase64,@RequestParam(value="newsNote",required=false)String note) {
